    ...
    <section style={{ background: "#0B0B0B", position: "relative", overflow: "hidden", padding: "100px 0 110px" }}>
      ...
      <style>{`
        ...
        @media (max-width: 780px) {
          .blog-masthead { grid-template-columns: 1fr; row-gap: 20px; align-items: start; }
        }
        ...
        @media (max-width: 780px) { .blog-headmeta { align-items: flex-start; text-align: left; } }
        .blog-sub {
        ...
        @media (max-width: 780px) { .blog-featured-imgwrap { min-height: 240px; } }
        .blog-featured-img {
        ...
        @media (max-width: 700px) {
          .blog-row { grid-template-columns: 30px 60px 1fr; row-gap: 6px; }
          .blog-row-meta, .blog-row-arrow { grid-column: 3 / 4; }
        }
        ...
        @media (max-width: 700px) { .blog-row-thumb { width: 60px; height: 44px; } }
        .blog-row-thumb img {
        ...
        @media (max-width: 700px) { .blog-row-title { white-space: normal; } }

  ...
  return (
    <>
      <style>{`
        ...
        .hdr-logo-shield {
          width: 46px; height: 46px; border: 2px solid #D4AF37; border-radius: 6px;
          display: flex; align-items: center; justify-content: center;
          background: rgba(212,175,55,0.07); transition: background 0.3s; flex-shrink: 0;
        }
        ...
        .hdr-logo-name {
          ...
          color: #F5F5F0; text-transform: uppercase;
        }
        .hdr-logo-name span { color: #D4AF37; }
        .hdr-logo-tagline {
          font-size: 9px; letter-spacing: 0.22em;
          color: rgba(212,175,55,0.7); text-transform: uppercase; margin-top: 3px;
        }
        ...
        .hdr-nav-link {
          ...
          color: rgba(245,245,240,0.82); text-decoration: none;
        ...
        .hdr-nav-link:hover,
        .hdr-nav-link[data-open="true"] { color: #D4AF37; }
        ...
        .hdr-dropdown {
          ...
          background: #0E0E0E; border: 1px solid rgba(212,175,55,0.2);
          border-radius: 12px;
        ...
        .hdr-dropdown::before {
          ...
          width: 12px; height: 12px; background: #0E0E0E;
        ...
        .hdr-dropdown-divider { margin: 0 18px; height: 1px; background: rgba(255,255,255,0.05); }
        .di-name {
          font-family: 'Bai Jamjuree', sans-serif; font-size: 13.5px; font-weight: 600;
          color: #F5F5F0; transition: color 0.2s; letter-spacing: 0.02em;
        }
        .di-desc { font-size: 11.5px; color: rgba(245,245,240,0.45); font-family: Georgia, serif; line-height: 1.4; }
        ...
        .hdr-phone-label { font-size: 10px; color: rgba(245,245,240,0.5); letter-spacing: 0.08em; text-transform: uppercase; }
        .hdr-phone-num { font-size: 15px; font-weight: 700; color: #F5F5F0; letter-spacing: 0.03em; }
        ...
        .hdr-book-btn {
          ...
          cursor: pointer; border-radius: 6px; color: #0A0A0A; transition: background 0.2s;
        }
        ...
        .hdr-hamburger:hover { background: rgba(212,175,55,0.1); border-color: #D4AF37; }
        ...
        .hdr-mobile {
          ...
          border-top: 1px solid rgba(212,175,55,0.12); background: #0A0A0A;
        }
        ...
        .hdr-mob-link {
          ...
          letter-spacing: 0.06em; text-transform: uppercase;
          color: rgba(245,245,240,0.85); text-decoration: none;
          border-bottom: 1px solid rgba(255,255,255,0.05); transition: color 0.2s;
        }
        .hdr-mob-link:hover { color: #D4AF37; }

        .hdr-mob-accordion { border-bottom: 1px solid rgba(255,255,255,0.05); }
        .hdr-mob-acc-btn {
          width: 100%; display: flex; align-items: center; justify-content: space-between;
          padding: 13px 0; font-size: 14px; font-weight: 600;
          letter-spacing: 0.06em; text-transform: uppercase;
          color: rgba(245,245,240,0.85); background: none; border: none;
        ...
        .hdr-mob-sub ul li a {
          ...
          color: rgba(245,245,240,0.65); text-decoration: none;
          border-radius: 6px; transition: color 0.2s, background 0.2s;
          font-family: Georgia, serif;
        }
        .hdr-mob-sub ul li a:hover { color: #D4AF37; background: rgba(212,175,55,0.07); }
        ...
        .hdr-mob-cta-icon {
          width: 34px; height: 34px; background: #D4AF37; border-radius: 50%;
          display: flex; align-items: center; justify-content: center; flex-shrink: 0;
        }
        .hdr-mob-cta-text label { display: block; font-size: 10px; color: rgba(245,245,240,0.5); letter-spacing: 0.1em; text-transform: uppercase; }
        .hdr-mob-cta-text span { font-size: 15px; font-weight: 700; color: #F5F5F0; letter-spacing: 0.03em; }

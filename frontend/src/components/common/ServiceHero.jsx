  ...
  return (
    <section className="relative min-h-[88vh] overflow-hidden flex flex-col justify-end">
      ...
      <div className="relative z-10 mx-auto max-w-7xl w-full px-5 sm:px-8 lg:px-10 pb-16 pt-32">
        ...
        <h1 className="text-[3.5rem] sm:text-[5rem] lg:text-[6.5rem] leading-[0.92] text-white max-w-4xl">
          {title}
        ...
        <p className="mt-6 max-w-lg text-[15px] font-light leading-relaxed text-[#B8B8B8]">
          {description}
        </p>
